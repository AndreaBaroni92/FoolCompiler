...
public class SVMParser extends Parser {
	...
	public static class LamInstrContext extends AssemblyContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SVMVisitor ) return ((SVMVisitor<? extends T>)visitor).visitLamInstr(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class HaltInstrContext extends AssemblyContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SVMVisitor ) return ((SVMVisitor<? extends T>)visitor).visitHaltInstr(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class MultInstrContext extends AssemblyContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SVMVisitor ) return ((SVMVisitor<? extends T>)visitor).visitMultInstr(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class LrvInstrContext extends AssemblyContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SVMVisitor ) return ((SVMVisitor<? extends T>)visitor).visitLrvInstr(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class SraInstrContext extends AssemblyContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SVMVisitor ) return ((SVMVisitor<? extends T>)visitor).visitSraInstr(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class LhpInstrContext extends AssemblyContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SVMVisitor ) return ((SVMVisitor<? extends T>)visitor).visitLhpInstr(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class LfpInstrContext extends AssemblyContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SVMVisitor ) return ((SVMVisitor<? extends T>)visitor).visitLfpInstr(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class PushLabInstrContext extends AssemblyContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SVMVisitor ) return ((SVMVisitor<? extends T>)visitor).visitPushLabInstr(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class LwInstrContext extends AssemblyContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SVMVisitor ) return ((SVMVisitor<? extends T>)visitor).visitLwInstr(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class PrintInstContext extends AssemblyContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SVMVisitor ) return ((SVMVisitor<? extends T>)visitor).visitPrintInst(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class LraInstrContext extends AssemblyContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SVMVisitor ) return ((SVMVisitor<? extends T>)visitor).visitLraInstr(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class AddInstrContext extends AssemblyContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SVMVisitor ) return ((SVMVisitor<? extends T>)visitor).visitAddInstr(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class SfpInstrContext extends AssemblyContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SVMVisitor ) return ((SVMVisitor<? extends T>)visitor).visitSfpInstr(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class CfpInstrContext extends AssemblyContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SVMVisitor ) return ((SVMVisitor<? extends T>)visitor).visitCfpInstr(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class SwInstrContext extends AssemblyContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SVMVisitor ) return ((SVMVisitor<? extends T>)visitor).visitSwInstr(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class CfvInstrContext extends AssemblyContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SVMVisitor ) return ((SVMVisitor<? extends T>)visitor).visitCfvInstr(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class BrancLEqInstrContext extends AssemblyContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SVMVisitor ) return ((SVMVisitor<? extends T>)visitor).visitBrancLEqInstr(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class SubInstrContext extends AssemblyContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SVMVisitor ) return ((SVMVisitor<? extends T>)visitor).visitSubInstr(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class DivInstrContext extends AssemblyContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SVMVisitor ) return ((SVMVisitor<? extends T>)visitor).visitDivInstr(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class PushNumbInstrContext extends AssemblyContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SVMVisitor ) return ((SVMVisitor<? extends T>)visitor).visitPushNumbInstr(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class JsInstrContext extends AssemblyContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SVMVisitor ) return ((SVMVisitor<? extends T>)visitor).visitJsInstr(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class OnlyLabelInstrContext extends AssemblyContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SVMVisitor ) return ((SVMVisitor<? extends T>)visitor).visitOnlyLabelInstr(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class LabelInstrContext extends AssemblyContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SVMVisitor ) return ((SVMVisitor<? extends T>)visitor).visitLabelInstr(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class BranchLabInstrContext extends AssemblyContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SVMVisitor ) return ((SVMVisitor<? extends T>)visitor).visitBranchLabInstr(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class NewInstrContext extends AssemblyContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SVMVisitor ) return ((SVMVisitor<? extends T>)visitor).visitNewInstr(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class SrvInstrContext extends AssemblyContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SVMVisitor ) return ((SVMVisitor<? extends T>)visitor).visitSrvInstr(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class PopInstrContext extends AssemblyContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SVMVisitor ) return ((SVMVisitor<? extends T>)visitor).visitPopInstr(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class ShpInstrContext extends AssemblyContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SVMVisitor ) return ((SVMVisitor<? extends T>)visitor).visitShpInstr(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class BrancEqInstrContext extends AssemblyContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SVMVisitor ) return ((SVMVisitor<? extends T>)visitor).visitBrancEqInstr(this);
			else return visitor.visitChildren(this);
		}
	}
